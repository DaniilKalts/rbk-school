...
import (
	...
	transporthttp "github.com/DaniilKalts/rbk-school/7-week/gateway-service/internal/adapter/transport/http"
...
func NewApp(cfg *config.Config, logger *zap.Logger) (*App, error) {
	...
	router := transporthttp.NewRouter(c.Logger, c.Dependencies, c.Config.Server.HandlerTimeout)
